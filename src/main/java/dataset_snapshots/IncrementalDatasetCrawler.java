...
public class IncrementalDatasetCrawler {
    ...
    public void crawlData(CrawlLog crawl_log) {
        ...
        Map<Integer, ResourceType> existing_resource_types = co.loadResourceTypes(mysql_connection);
    ...
    private void analyseResourceValueUpdates(Set<String> update_resource_uris, Map<String, Integer> resource_uris, Dataset dataset, ResourceType resource_type,
        ...
        for (int resource_id : existing_resources.keySet()) {
            ...
            if (current_resource_values != resource.getNonDeletedResourceValues()) {
                ...
                boolean hasResourceChanged = compareResourceValues(resource, live_resource, crawl_log);
     ...
     * @return
     */
    private boolean compareResourceValues(Resource existing_resource, Resource live_resource, CrawlLog crawl_log) {
        ...
        Map<String, List<ResourceValue>> existing_property_uri_res_values = new TreeMap<String, List<ResourceValue>>();
        Map<String, List<ResourceValue>> live_property_uri_res_values = new TreeMap<String, List<ResourceValue>>();
